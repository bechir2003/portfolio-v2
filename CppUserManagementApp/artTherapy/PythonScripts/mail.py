...
def send_email():
    ...
    #receiver_email = "mejrib430@gmail.com"
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <p class="official-staff">Please do not share this code with anyone. It is for your use only.</p>
          <p>Best regards,<br>Virtuoso Vision</p>
        </div>
      </body>
    </html>
    """
